...
const stores = [
  {name:'ก๋วยเตี๋ยวเรือสยาม', description:'ก๋วยเตี๋ยวเรือเข้มข้น เส้นเหนียวนุ่ม น้ำซุปหอมเครื่องเทศ', location:'โรงอาหารกลาง แถว B ล็อก 1', image_url:'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&q=80&auto=format&fit=crop', pin_hash: hashPin('1111')},
  {name:'ไก่ทอดหาดใหญ่ บังยี', description:'ไก่ทอดกรอบนอกนุ่มใน หอมเจียวกรอบ สูตรหาดใหญ่แท้', location:'โรงอาหารกลาง แถว A ล็อก 7', image_url:'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&q=80&auto=format&fit=crop', pin_hash: hashPin('2222')},
  {name:'ชานมไข่มุก Chill Bar', description:'ชานมไต้หวัน ชาเขียวมัทฉะ ผลไม้ปั่น ขนมปังปิ้ง', location:'โรงอาหารกลาง หน้าทางเข้า', image_url:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80&auto=format&fit=crop', pin_hash: hashPin('3333')},
  {name:'ครัวคุณแม่ — อาหารตามสั่ง', description:'ผัดกะเพรา ข้าวผัด ผัดซีอิ๊ว ราดหน้า ทำใหม่จานต่อจาน', location:'โรงอาหารกลาง แถว C ล็อก 2', image_url:'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&q=80&auto=format&fit=crop', pin_hash: hashPin('4444')},
];
